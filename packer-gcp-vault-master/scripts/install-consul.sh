...
#==============================================================================
#title            : install_consul.sh
#description      : This script will install/configure HashiCorp Consul
#author			  : Cory Stein
#date             : 11/27/2017
#version          : 0.1
#usage            : ./install_consul.sh
...
# Download the HashiCorp Consul (Enterprise)
#wget -O /tmp/consul.zip https://s3-us-west-2.amazonaws.com/hc-enterprise-binaries/consul/ent/1.4.0/consul-enterprise_1.4.0%2Bent_linux_amd64.zip
# Downloading Consul OS for now:
# wget -O /tmp/consul.zip "$CONSUL_DOWNLOAD_URL"
# Using gsutil
gsutil cp $CONSUL_DOWNLOAD_URL /tmp/consul.zip
